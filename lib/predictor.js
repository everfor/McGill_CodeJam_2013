...
function higherConfidenceInterval(prediction) {
	return parseFloat(prediction) + Math.sqrt(cost);
}
...
exports.lowerConfidenceInterval = lowerConfidenceInterval;
exports.higherConfidenceInterval = higherConfidenceInterval;