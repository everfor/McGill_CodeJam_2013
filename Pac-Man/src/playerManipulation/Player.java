 ...
 * A player's information is stored here during the duration of him/her logged in.
 * The class also handles getting this information as well as clearing it for log out.
 * Player information includes: username, password, security answer, security question,
 * maximum level achieved and a players high scores. 
 */
public class Player {
 ...
 * in order to manipulate or obtain their information prior to writing to the database
...
/**
 * Given a player's new score it attempts to add it to his/her
 * top 10 high scores. It will only be added if it is at least higher
 * that the player's current 10th highest score
 * @param newScore the score that was obtained by the player
 */
