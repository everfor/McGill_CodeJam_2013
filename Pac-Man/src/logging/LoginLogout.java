...
public class LoginLogout extends LoggingGUI{
	...
	public static void logout(){
		if (Player.clearPlayer()){
			//pop-up notification of successful login
			JOptionPane.showMessageDialog(null, "Successful Logout","",JOptionPane.INFORMATION_MESSAGE);			
			pages.show(pagePanels, "login");
		}
		else {
			//pop-up notification of unsuccessful login
			JOptionPane.showMessageDialog(null, "Unsuccessful Logout, please try again","Error",JOptionPane.ERROR_MESSAGE);
		}
