...
public class Map extends JPanel {
	...
	static int newBoard[][] = new int[width][height];

	static Image wall, space, dot, energizer, tunnel, score, lives, door, life,
			cherry;
	...
	public void addExtras(Pacman pacman, Graphics g){
		...
		scoreCounter = Score.getScore(board);
		g.setFont(new Font("Comic Sans MS", Font.BOLD, 27));
	    g.setColor(Color.yellow);
		g.drawString("" + scoreCounter, (int) (5.3*Game.pixel), (int) (32.5*Game.pixel));
	...
	/**
	 * Method that check whether the fruit has been eaten and sets fruitVisible
	 * accordingly
	 * 
	 * @param board
	 * 
