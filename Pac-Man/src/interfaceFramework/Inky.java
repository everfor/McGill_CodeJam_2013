...
/**
 * The class is for the ghost, inky. The class incorporates all the attributes that this ghost
 * should have.
 * 
 */
public class Inky extends Ghost {
	...
	/**
	 * Checking the possible movements that can be done by inky if it is in scatter,chase or
	 * frightened move
	 * 
	 * @param pacman
	...
	/**
	 * the method computes the target tile for inky, based on its own AI, and changes it if
	 * necessary
	 */
