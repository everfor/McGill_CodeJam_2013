...
public class Game extends JPanel implements ActionListener, KeyListener {
	...
	/**
	 * Paints in most of the graphics, take @param g, an object of Graphics
	 * Paints the appropriate direction-facing images for Pac-Man
	 * Also, paints the apt images for ghosts and frightened ghosts
	 * Paints in colours and fonts of the level graphic
	 * Finally, it also paints the fruits and consumption of collectables when required
	 */
	...
	/**
	 * If no turn available, stores the turn's direction
	 *  and runs in its next avalable incarnation
	 */
	...
	/** Method to deal with the end of Game
