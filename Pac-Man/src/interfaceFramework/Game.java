...
//			ghost1.move(map.board, ghost1.moveLeft());
			ghost1.movePossible(pacman, map.board);
			checkCollision();
		}
	...
	public void checkCollision() {
		...
		if(!ghost1.goDownGhost && !ghost1.goUpGhost && !ghost1.goRightGhost && !ghost1.goLeftGhost && !stop && ((int) pacman.getX() == ghost1.getX() && (int) pacman.getY() == ghost1.getY())) {
			inGame = false;
		}
		
		else if(((!ghost1.goDownGhost && !ghost1.goUpGhost && !ghost1.goRightGhost && !ghost1.goLeftGhost) || (!stop)) && ((int) pacman.getX() == ghost1.getX() && (int) pacman.getY() == ghost1.getY())) {
			inGame = false;
		}
...
//		else if(goRight && ghost1.goLeft && (ghost1.getX() - pacman.getX() == 1)){
...
//		System.out.println(goRight + " " + ghost1.goLeft);
		...
		else if((goDown && ghost1.goUpGhost) || (goUp && ghost1.goDownGhost) || (goRight && ghost1.goLeftGhost) || (goLeft && ghost1.goRightGhost)){
