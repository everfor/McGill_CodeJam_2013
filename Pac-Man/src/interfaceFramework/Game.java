 ...
 * It also deals with the Pause and Resume and Pac-Man's movement
 */
...
/**
  * Constructor which sets the timer to 200 and starts it
  * Calls invalidate and then adds this component's validateRoot to a list of components that need to be validated. 
  * Validation will occur after all currently pending events have been dispatched. 
  * In other words after this method is called, the first validateRoot (if any) found when walking up the containment hierarchy of this component will be validated.
  * Also Repaints this component. 
  */
...
/**
  * The method imports and paints the Pac-Man and Ghost pictures into the Maze. 
  * It paints the map that is created in the Map class
  * It paints a different picture of Pac-Man depending on the direction in which Pac-Man is going
  * Finally, it moves Pac-Man and Ghost based on the results of the checkCollision method
  * 
  * @param g
...
//   ghost1.move(map.board, ghost1.moveLeft());
 ...
 /**
  * The method checks for potential collisions and impediments to the progress of the characters
  * if there are impediments to the character's movement such as a wall or another character, 
  * this method changes the boolean ingame to false
  * This boolean is then painted in using the aforementioned paint method 
  * 
  * @return void
  */
...
//  }
 ...
 /**
  * The method creates the Pause for the game using p
  * It uses a stopped timer to implement the Pause
  * It also prints "There is a problem" if an exception is found
  * 
  * @return void
  */
 ...
 /**
  * The method is the one that resumes game using the r keypress 
  * It starts the timer stopped by the pauseSession method
  * It also prints "There is a problem" if an exception is found
  * 
  * @return void
  */
 ...
 /**
  * this method, utilizing case statements, checks if pacman can move in the inputted direction,
  * and then moves pacman accordingly
  * @param e
